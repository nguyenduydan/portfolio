                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-centerp-10 rounded-4xl py-5'>
                    ...
                    <div className={`transition-all duration-1000 delay-300 ${hasAnimated.about ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-10"}`}>
                        <div className='space-y-6'>
                            <p className='text-gray-600 text-lg leading-relaxed'> Xin chào! Mình là một <span className='text-[#00d369] font-semibold'>Lập trình viên Backend</span> mới ra trường, đam mê xây dựng các ứng dụng web ổn định và những API mạnh mẽ, mang lại trải nghiệm tốt nhất cho người dùng.
                            </p>
                            <p className='text-gray-600 text-lg leading-relaxed'> Mình có kiến thức và kinh nghiệm thực hành với các ngôn ngữ lập trình như <span className='text-[#00d369] font-semibold'>PHP, JavaScript, HTML/CSS, C++, C#</span> cùng với các framework hiện đại như <span className='text-[#00d369] font-semibold'>ReactJS, ASP.NET, Express và Laravel</span>. Ngoài ra, mình quen thuộc với nhiều hệ quản trị cơ sở dữ liệu như <span className='text-[#00d369] font-semibold'>SQL Server, MySQL</span> và <span className='text-[#00d369] font-semibold'>MongoDB</span>.
                            </p>
                            <p className='text-gray-600 text-lg leading-relaxed'> Mình là người <span className='text-[#00d369] font-semibold'>lập kế hoạch hiệu quả</span>, có khả năng phối hợp tốt trong môi trường làm việc có thời hạn chặt chẽ. Là một người <span className='text-[#00d369] font-semibold'>cởi mở và nhiệt tình</span>, mình luôn sẵn sàng học hỏi và hợp tác để cùng nhóm đạt được kết quả tốt nhất.
                            </p>
                        </div>
                        {/* Action Buttons */}
